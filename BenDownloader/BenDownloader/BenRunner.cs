...
namespace BenDownloader
{
    public class BenRunner : IDisposable
    {
        ...
        #region [Methods]
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="BenRunner"/> object and optionally releases the managed resources.
        /// </summary>
        public void Dispose()
        {
            if (!m_disposed)
        ...
        public bool XferAllFiles()
        {
            ...
            {
                UpdateStatusLogDatabase(ex.Message, true);
